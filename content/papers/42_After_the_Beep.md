...
tags = ["IoT-enabled domestic object(s)", "Application"]
...
design_input = ["Touch – non-typing via display", "Audio", "Media content", "Behavioral data"]
design_output = ["Audio", "Media content", "Specific object activity"]
